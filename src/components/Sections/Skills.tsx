...
import { Code2, Server, Cpu, Database, Zap, GitBranch, Cloud, Container, Terminal, Network, Settings } from 'lucide-react'
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          <div className="p-4 bg-gray-900/30 rounded-xl border border-gray-700/30">
            ...
            <div className="text-white font-medium text-sm mb-1">Современный стек</div>
            <div className="text-gray-400 text-xs">Актуальные технологии</div>
          </div>
          
          <div className="p-4 bg-gray-900/30 rounded-xl border border-gray-700/30">
            <Settings className="w-6 h-6 text-green-400 mx-auto mb-2" />
            <div className="text-white font-medium text-sm mb-1">Постоянное развитие</div>
            <div className="text-gray-400 text-xs">Изучаю новые инструменты</div>
          </div>
          
          <div className="p-4 bg-gray-900/30 rounded-xl border border-gray-700/30">
            <Cloud className="w-6 h-6 text-purple-400 mx-auto mb-2" />
            <div className="text-white font-medium text-sm mb-1">Полный цикл</div>
            <div className="text-gray-400 text-xs">От идеи до продакшена</div>
          </div>
        </div>
      </div>
    </section>
